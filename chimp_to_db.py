...
def chimp_to_db(amount):
    ...
    mail('timothy@webfaster.com', 'timothy@webfaster.com', 'Circuit Sortie Mailchimp Sync', f'<h1>Circuit Sortie Mailchimp syncing with email collection</h1><ul><li>{duplicates} addresses without changes</li><li>{updated_addresses} addresses with changes</li><<li>{new_addresses} new addresses</li>/ul>')
